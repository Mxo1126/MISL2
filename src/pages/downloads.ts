...
class DownloadsPage {
    ...
    private previewDocument(url: string): void {
        try {
    ...
    private setupKeyboardNavigation(): void {
        ...
        const handleKeyPress = (e: KeyboardEvent, buttons: NodeListOf<Element>) => {
            const current = document.activeElement;
            const list = Array.from(buttons);
            const index = list.indexOf(current as Element);
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key === 'Escape') {
                const searchInput = document.querySelector<HTMLInputElement>('#document-search');
    ...
    private updateActiveFilters(): void {
        ...
        document.querySelectorAll('.category-filter').forEach(button => {
            ...
            (button as HTMLElement).setAttribute('aria-pressed', isActive.toString());
        });
    ...
    private getDocumentCardHTML(doc: Document): string {
        return `
    ...
    private setupDocumentActions(): void {
        // Download buttons
